...
var ResultStreamObserver = /** @class */ (function (_super) {
     ...
     */
    ResultStreamObserver.prototype.onError = function (error, runError) {
    ...
    ResultStreamObserver.prototype.unsubscribeAll = function () {
        this._observers = [];
    };
    ...
    ResultStreamObserver.prototype._handleError = function (error, runError) {
        var _this = this;
    ...
    ResultStreamObserver.prototype._handleStreaming = function () {
        if (this._head && (this._observers.some(function (o) { return o.onNext || o.onCompleted; }) || this._discard)) {
...
var _states = {
    READY_STREAMING: {
        ...
        onError: function (streamObserver, error, runError) {
            streamObserver._handleError(error, runError !== null && runError !== void 0 ? runError : true);
        },
        name: function () {
            return 'READY_STREAMING';
        },
        pull: function () { },
        discard: function (obs) { obs._discard = true; }
    },
    READY: {
    ...
    STREAMING: {
        ...
        onError: function (streamObserver, error, runError) {
            streamObserver._handleError(error, runError !== null && runError !== void 0 ? runError : false);
        },
        name: function () {
            return 'STREAMING';
        },
