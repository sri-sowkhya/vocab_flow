...
var Driver = /** @class */ (function () {
    ...
    */
    ...
    Driver.prototype.executeQuery = function (query_1, parameters_1) {
        return __awaiter(this, arguments, void 0, function (query, parameters, config, parameterRules) {
    ...
    Driver.prototype._newSession = function (_a) {
        var defaultAccessMode = _a.defaultAccessMode, bookmarkOrBookmarks = _a.bookmarkOrBookmarks, database = _a.database, reactive = _a.reactive, impersonatedUser = _a.impersonatedUser, fetchSize = _a.fetchSize, bookmarkManager = _a.bookmarkManager, notificationFilter = _a.notificationFilter, auth = _a.auth, disableAutoCommitRetries = _a.disableAutoCommitRetries;
