...
var GenericResult = /** @class */ (function () {
     ...
     */
    function GenericResult(streamObserverPromise, query, parameters, connectionHolder, watermarks, retry) {
    ...
    GenericResult.prototype.summary = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this._streamObserverPromise
                .then(function (o) {
                var summaryObserver = _this._decorateObserver({
                    // This type casting is needed since we are defining the number type of
                    // summary in Result template
                ...
                o.cancel();
                // @ts-expect-error
                _this._ownedObservers.push(summaryObserver);
    ...
    GenericResult.prototype._getOrCreatePromise = function () {
        ...
        if (this._p == null) {
            this._p = new Promise(function (resolve, reject) {
                ...
                _this._subscribe(observer).catch(function () { });
            });
        }
        return this._p;
    };
     ...
     */
    GenericResult.prototype._subscribe = function (observer, paused, skipOnCompleted) {
        if (paused === void 0) { paused = false; }
        if (skipOnCompleted === void 0) { skipOnCompleted = false; }
        var _observer = this._decorateObserver(observer, skipOnCompleted);
        // @ts-expect-error
     ...
     */
    GenericResult.prototype._decorateObserver = function (observer, skipOnCompleted) {
        var _this = this;
        var _b, _c, _d;
        ...
        var onErrorWrapper = function (error, runError) {
            var _b;
            if (runError === true && _this._retriedError === undefined && error instanceof error_1.Neo4jError &&
                ((_b = error.diagnosticRecord) === null || _b === void 0 ? void 0 : _b._idempotent) === true && _this._retry !== undefined) {
                _this._retriedError = error;
                _this._streamObserverPromise.then(function (obs) { if (obs.unsubscribeAll !== undefined)
                    obs.unsubscribeAll(); }, function () { });
                _this._streamObserverPromise = _this._retry();
                _this._streamObserverPromise.then(function (obs) {
                    _this._ownedObservers.forEach(function (o) {
                        obs.subscribe(o);
                    });
                }, function () { });
            }
            else if (_this._retriedError !== error) {
