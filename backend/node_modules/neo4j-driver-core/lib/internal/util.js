...
function validateQueryAndParameters(query, parameters, opt) {
    ...
    var parameterRules = opt === null || opt === void 0 ? void 0 : opt.parameterRules;
    ...
    if (typeof query === 'string') {
        ...
        if (!skipAsserts) {
            ...
            if ((opt === null || opt === void 0 ? void 0 : opt.parameterRules) != null) {
                throw (0, error_1.newError)('When using a Query object, parameterRules should be present in the object and not in a separate argument.');
            }
        }
    ...
    if (!skipAsserts) {
        params = (0, mapping_highlevel_1.validateAndCleanParameters)(params, parameterRules);
