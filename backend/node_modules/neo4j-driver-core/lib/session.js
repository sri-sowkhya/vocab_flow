...
var Session = /** @class */ (function () {
    ...
    function Session(_a) {
        ...
        this._disableAutoCommitRetries = (_c = disableAutoCommitRetries !== null && disableAutoCommitRetries !== void 0 ? disableAutoCommitRetries : config === null || config === void 0 ? void 0 : config.disableAutoCommitRetries) !== null && _c !== void 0 ? _c : false;
    }
    /**
     * Run Cypher query
     ...
     */
    Session.prototype.run = function (query, parameters, transactionConfig, parameterRules) {
        var _this = this;
        var _a = (0, util_1.validateQueryAndParameters)(query, parameters, { parameterRules: parameterRules }), validatedQuery = _a.validatedQuery, params = _a.params;
        ...
        var result = this._run(validatedQuery, params, function (connection, noTelemetry) { return __awaiter(_this, void 0, void 0, function () {
            var bookmarks;
            var _this = this;
    ...
    Session.prototype._run = function (query, parameters, customRunner) {
        ...
        var retryFunction = this._disableAutoCommitRetries
            ? undefined
            : function () {
                var resultPromise = _this._acquireAndConsumeConnection(customRunner, true).resultPromise;
                return resultPromise.catch(function (error) { return Promise.resolve(new observers_1.FailedObserver({ error: error })); });
            };
        return new result_1.default(observerPromise, query, parameters, connectionHolder, watermarks, retryFunction);
    };
    /**
     ...
     */
    Session.prototype._acquireAndConsumeConnection = function (connectionConsumer, isAutoCommitRetry) {
        var resultPromise;
        ...
        if (!this._open) {
            ...
            resultPromise = connectionHolder
                ...
                .then(function (connection) { return connectionConsumer(connection, isAutoCommitRetry); });
        }
        else {
    ...
    Session.prototype._beginTransaction = function (accessMode, txConfig, apiTelemetryConfig) {
        ...
        if (this._hasTx) {
            throw (0, error_1.newError)('You cannot begin a transaction on a session with ongoing work; ' +
