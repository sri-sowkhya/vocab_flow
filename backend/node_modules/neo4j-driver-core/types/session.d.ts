...
declare class Session {
    ...
    private readonly _disableAutoCommitRetries;
    /**
     * @constructor
     * @protected
     * @param {Object} args
     ...
     */
    constructor({ mode, connectionProvider, bookmarks, database, config, reactive, fetchSize, impersonatedUser, bookmarkManager, notificationFilter, auth, log, homeDatabaseCallback, disableAutoCommitRetries }: {
        mode: SessionMode;
     ...
     */
    run<R extends RecordShape = RecordShape>(query: Query, parameters?: any, transactionConfig?: TransactionConfig, parameterRules?: Rules): Result<R>;
